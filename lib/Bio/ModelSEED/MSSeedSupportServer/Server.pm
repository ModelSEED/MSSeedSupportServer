package Bio::ModelSEED::MSSeedSupportServer::Server;
...
sub call_method {
    ...
    my $ctx = Bio::ModelSEED::MSSeedSupportServer::ServerContext->new($self->{loggers}->{userlog},
...

{
	...
	my $stderr = Bio::ModelSEED::MSSeedSupportServer::ServerStderrWrapper->new($ctx, $get_time);
	$ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service MSSeedSupportServer.");
    }
...
package Bio::ModelSEED::MSSeedSupportServer::ServerContext;

use strict;

=head1 NAME

Bio::ModelSEED::MSSeedSupportServer::ServerContext
...
package Bio::ModelSEED::MSSeedSupportServer::ServerStderrWrapper;
