...
class MSSeedSupportServer:
    ...
    def getRastGenomeData(self, params):
        ...
        arg_hash = { 'method': 'MSSeedSupportServer.getRastGenomeData',
                     'params': [params],
                     'version': '1.1',
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def get_user_info(self, params):
        ...
        arg_hash = { 'method': 'MSSeedSupportServer.get_user_info',
                     'params': [params],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def authenticate(self, params):
        ...
        arg_hash = { 'method': 'MSSeedSupportServer.authenticate',
                     'params': [params],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def load_model_to_modelseed(self, params):
        ...
        arg_hash = { 'method': 'MSSeedSupportServer.load_model_to_modelseed',
                     'params': [params],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def create_plantseed_job(self, params):
        ...
        arg_hash = { 'method': 'MSSeedSupportServer.create_plantseed_job',
                     'params': [params],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def get_plantseed_genomes(self, params):
        ...
        arg_hash = { 'method': 'MSSeedSupportServer.get_plantseed_genomes',
                     'params': [params],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def kblogin(self, params):
        ...
        arg_hash = { 'method': 'MSSeedSupportServer.kblogin',
                     'params': [params],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def kblogin_from_token(self, params):
        ...
        arg_hash = { 'method': 'MSSeedSupportServer.kblogin_from_token',
                     'params': [params],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
