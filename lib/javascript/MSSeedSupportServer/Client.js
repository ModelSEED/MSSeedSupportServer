...
function MSSeedSupportServer(url, auth, auth_cb) {
    ...
    this.list_rast_jobs = function (input, _callback, _errorCallback) {
    return json_call_ajax("MSSeedSupportServer.list_rast_jobs",
        [input], 1, _callback, _errorCallback);
};

    this.list_rast_jobs_async = function (input, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("MSSeedSupportServer.list_rast_jobs", [input], 1, _callback, _error_callback);
    };
