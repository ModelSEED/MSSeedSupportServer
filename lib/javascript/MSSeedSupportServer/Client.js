...
function MSSeedSupportServer(url, auth, auth_cb) {
    ...
    this.list_rast_jobs = function (params, _callback, _errorCallback) {
    return json_call_ajax("MSSeedSupportServer.list_rast_jobs",
        [params], 1, _callback, _errorCallback);
};

    this.list_rast_jobs_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("MSSeedSupportServer.list_rast_jobs", [params], 1, _callback, _error_callback);
    };
